"""
Django settings for lab5_blog_proj project.
...
SECRET_KEY = 'v$_663v8m#rip3%f$xe^pmqz4t$2*t+$8$yk69q%)7+)339wi$'
...
ROOT_URLCONF = 'lab5_blog_proj.urls'
...
WSGI_APPLICATION = 'lab5_blog_proj.wsgi.application'
